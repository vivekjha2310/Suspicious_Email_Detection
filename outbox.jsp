...
<head >
	...
	<style type="text/css">
		body{
			 ...
			 background-image: url("images/outbox1.png");
		}
		table
		{
			min-width: 100%;
...
<body style=" background-image: url("images/outbox1.png")">
    <%  
        try{
         String msg1="welcome";
         ...
         if(rs.next())
         {
             String sql1="select * from "+rs.getString(1)+" where outbox IS NOT NULL;";
	...
	<tr></br>
        ...
        <tr><td><%=rs1.getString(1) %></td><td><%=rs1.getString(3) %></td>
