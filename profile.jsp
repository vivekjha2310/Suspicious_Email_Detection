				...
				<div id="right">
					<fieldset>
						...
						<table>
							...
							<tr>
								<td>Recovery Mail:</td>
								<td><input type="mail" name="uemail"  value="<%= rs.getString(5)%>" readonly></td>
							</tr>
							<tr>
								<td>User Id: </td>
							...
							<tr>
								<td>Mobile No.:</td>
								<td><input type="tel" name="uno"  value="<%= rs.getLong(7)%>" readonly></td>
							</tr>
							<tr>
								<td>About:</td>
								<td><input type="text" name="about" title="About User" value="<%= rs.getString(9)%>" readonly></td>
							</tr>
						</table>
					</fieldset>
				</div>
