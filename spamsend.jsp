...
ResultSet rs=p.executeQuery();                          
                //String ss =b.substring(0, (b.length()-1));
                    if(rs.next()&&rs2.next())
                        {//next if open
                String sl2="insert into " +rs2.getString(1)+ "(sent,too,frm) values(?,?,?);";   
                String sl1="insert into " +rs.getString(1)+ "(spam,too,frm) values(?,?,?);";
                PreparedStatement p1=con1.prepareStatement(sl1);
                PreparedStatement p3=con3.prepareStatement(sl2);
                p1.setString(1, text);
                p1.setString(3,n);
                p1.setString(2,to);
                p3.setString(1, text);
