...
<body>
    <%  
        try{
         ...
         if(rs.next())
         {
             ...
             String sql1="select * from "+rs.getString(1)+" where sent IS NOT NULL;";
	...
	<tr></br>
        ...
        <tr><td><%=rs1.getString(1) %></td><td><%=rs1.getString(9) %></td><td><%=rs1.getString(4) %></td>
            <td><a href='deletesend.jsp?x2=<%= rs1.getString(4)%>'>delete</a></td>
