...
<head >
	<title></title>
	<style type="text/css">
		body{     background-image: url("images/inbox.jpg");
...
<body>
    <%  
        try{
         ...
         if(rs.next())
         {
             ...
             String sql1="select * from "+rs.getString(1)+" where inbox IS NOT NULL;";
	...
	<tr><br/>
        ...
        <tr><td><%=rs1.getString(1) %></td><td><%=rs1.getString(10) %></td><td><%=rs1.getString(2) %></td>
            <td><a href='deleteinbox.jsp?x2=<%= rs1.getString(2)%>'>delete</a></td>
