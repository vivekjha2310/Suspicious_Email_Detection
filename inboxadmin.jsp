...
<body>
    <%  
        try{
         ...
         if(rs.next())
         {
             String sql1="select * from admindb where inbox IS NOT NULL;";
	...
	<tr>
        ...
        <tr><td><%=rs1.getString(1) %></td><td><%=rs1.getString(8) %></td><td><%=rs1.getString(2) %></td>
            <td><a href='deleteinboxadmin.jsp?x2=<%= rs1.getString(2)%>'>delete</a></td>
