    ...
    <body>
        <div class="container">
			...
			<header>
                            ...
                            <h1><center><strong>Admin Login Form</strong></center></h1>
				
			</header>
			
			<section class="main">
			<form action="validadmin.jsp" class="form-2" method="post">
                        <% String msg=(String)request.getAttribute("message");%>
					<h1><span class="log-in">Log in</span> </h1>
					<p class="float">
						<label for="login"><i class="icon-user"></i>Username</label>
						<input type="text" name="uid" placeholder="example@mspvr.com">
					</p>
					<p class="float">
